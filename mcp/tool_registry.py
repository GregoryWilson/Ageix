...
class MCPToolRegistry:
    ...
    def discover(self, *, include_disabled: bool = False) -> list[dict[str, object]]:
        return [tool.to_discovery_dict() for tool in self.list_tools(include_disabled=include_disabled)]
