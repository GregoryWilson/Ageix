...
MCP_TOOL_DEFINITIONS: tuple[MCPToolDefinition, ...] = (
    ...
    MCPToolDefinition(
        name="ageix.repo.fetch",
        capability_id="repo.fetch",
        category="repository",
        description="Fetch remote-tracking refs without modifying the working tree. Not gated -- non-destructive and reversible.",
        input_schema=_object_schema({
            "remote": _string("Remote name. Defaults to origin."),
        }),
    ),
    MCPToolDefinition(
        name="ageix.repo.tag.list",
        capability_id="repo.tag.list",
        category="repository",
        description="List local repository tags.",
        input_schema=_object_schema({}),
    ),
    MCPToolDefinition(
        name="ageix.repo.pull",
        capability_id="repo.pull",
        category="repository",
        description="Fast-forward-only pull from a remote. Requires an active sprint grant or a one-off human approval.",
        input_schema=_object_schema({
            "remote": _string("Remote name. Defaults to origin."),
            "branch": _string("Optional branch to pull. Defaults to the current branch's upstream."),
            "sprint_id": _string("Sprint ID covered by an active repo write grant."),
            "approval_id": _string("One-off approval ID issued via repo.write.approve."),
        }),
        documentation={
            "use_when": ["Bring the local working copy up to date with the remote before further work."],
            "do_not_use_when": ["Do not use without an active sprint grant or a one-off approval; the call will be denied."],
        },
    ),
    MCPToolDefinition(
        name="ageix.repo.checkout",
        capability_id="repo.checkout",
        category="repository",
        description="Checkout an existing or new branch/ref. Requires an active sprint grant or a one-off human approval.",
        input_schema=_object_schema({
            "ref": _string("Branch or ref to check out."),
            "create": _boolean("Create the branch if it does not exist."),
            "sprint_id": _string("Sprint ID covered by an active repo write grant."),
            "approval_id": _string("One-off approval ID issued via repo.write.approve."),
        }, required=["ref"]),
    ),
    MCPToolDefinition(
        name="ageix.repo.branch.create",
        capability_id="repo.branch.create",
        category="repository",
        description="Create a local branch. Requires an active sprint grant or a one-off human approval.",
        input_schema=_object_schema({
            "name": _string("New branch name."),
            "start_point": _string("Optional starting ref. Defaults to HEAD."),
            "sprint_id": _string("Sprint ID covered by an active repo write grant."),
            "approval_id": _string("One-off approval ID issued via repo.write.approve."),
        }, required=["name"]),
    ),
    MCPToolDefinition(
        name="ageix.repo.branch.delete",
        capability_id="repo.branch.delete",
        category="repository",
        description="Delete a fully-merged local branch. Requires an active sprint grant or a one-off human approval.",
        input_schema=_object_schema({
            "name": _string("Branch name to delete."),
            "sprint_id": _string("Sprint ID covered by an active repo write grant."),
            "approval_id": _string("One-off approval ID issued via repo.write.approve."),
        }, required=["name"]),
    ),
    MCPToolDefinition(
        name="ageix.repo.tag.create",
        capability_id="repo.tag.create",
        category="repository",
        description="Create a local tag. Requires an active sprint grant or a one-off human approval.",
        input_schema=_object_schema({
            "name": _string("Tag name."),
            "message": _string("Optional annotation message. Creates an annotated tag when set."),
            "ref": _string("Optional ref to tag. Defaults to HEAD."),
            "sprint_id": _string("Sprint ID covered by an active repo write grant."),
            "approval_id": _string("One-off approval ID issued via repo.write.approve."),
        }, required=["name"]),
    ),
    MCPToolDefinition(
        name="ageix.repo.tag.delete",
        capability_id="repo.tag.delete",
        category="repository",
        description="Delete a local tag. Requires an active sprint grant or a one-off human approval.",
        input_schema=_object_schema({
            "name": _string("Tag name to delete."),
            "sprint_id": _string("Sprint ID covered by an active repo write grant."),
            "approval_id": _string("One-off approval ID issued via repo.write.approve."),
        }, required=["name"]),
    ),
    MCPToolDefinition(
        name="ageix.repo.commit",
        capability_id="repo.commit",
        category="repository",
        description="Stage listed paths (optional) and create a commit. Requires an active sprint grant or a one-off human approval.",
        input_schema=_object_schema({
            "message": _string("Commit message."),
            "paths": _array("Optional repo-relative paths to stage before committing. Omit to commit already-staged changes."),
            "sprint_id": _string("Sprint ID covered by an active repo write grant."),
            "approval_id": _string("One-off approval ID issued via repo.write.approve."),
        }, required=["message"]),
    ),
    MCPToolDefinition(
        name="ageix.repo.push",
        capability_id="repo.push",
        category="repository",
        description="Push a non-default branch to a remote. Requires an active sprint grant or a one-off human approval. Refuses the default branch -- use ageix.repo.push.main.",
        input_schema=_object_schema({
            "remote": _string("Remote name. Defaults to origin."),
            "branch": _string("Branch to push. Defaults to the current branch."),
            "set_upstream": _boolean("Set the upstream tracking branch. Defaults to true."),
            "sprint_id": _string("Sprint ID covered by an active repo write grant."),
            "approval_id": _string("One-off approval ID issued via repo.write.approve."),
        }),
        documentation={
            "do_not_use_when": ["Do not use this tool to push the repository's default branch; use ageix.repo.push.main instead."],
        },
    ),
    MCPToolDefinition(
        name="ageix.repo.push.main",
        capability_id="repo.push.main",
        category="repository",
        description="Push the default branch to a remote. Always requires a fresh, single-use human approval; never satisfiable by a sprint grant.",
        input_schema=_object_schema({
            "remote": _string("Remote name. Defaults to origin."),
            "approval_id": _string("One-off approval ID issued via repo.write.approve for capability_id repo.push.main."),
        }, required=["approval_id"]),
        documentation={
            "use_when": ["Pushing directly to the repository's default branch, with fresh human sign-off for this specific call."],
            "do_not_use_when": ["Do not rely on a sprint grant -- this tool always requires a new approval_id."],
        },
    ),
    MCPToolDefinition(
        name="ageix.repo.write.grant.create",
        capability_id="repo.write.grant.create",
        category="repository",
        description="Human-only: grant a standing sprint-level override for mutating git capabilities (excludes repo.push.main).",
        input_schema=_object_schema({
            "sprint_id": _string("Sprint identifier this grant covers."),
            "granted_by": _string("Must be the literal string 'human'."),
            "capability_ids": _array("Optional subset of mutating repo capability IDs to grant. Defaults to all grantable capabilities."),
            "expires_at": _string("Optional ISO-8601 expiry timestamp."),
            "reason": _string("Human-readable justification."),
        }, required=["sprint_id", "granted_by"]),
    ),
    MCPToolDefinition(
        name="ageix.repo.write.grant.revoke",
        capability_id="repo.write.grant.revoke",
        category="repository",
        description="Human-only: revoke a sprint-level repo write grant.",
        input_schema=_object_schema({
            "grant_id": _string("Grant ID to revoke."),
            "revoked_by": _string("Must be the literal string 'human'."),
        }, required=["grant_id", "revoked_by"]),
    ),
    MCPToolDefinition(
        name="ageix.repo.write.grant.list",
        capability_id="repo.write.grant.list",
        category="repository",
        description="List sprint-level repo write grants.",
        input_schema=_object_schema({
            "sprint_id": _string("Optional sprint ID filter."),
            "status": _string("Optional status filter."),
            "limit": _integer("Maximum grants to return."),
            "offset": _integer("Zero-based grant offset."),
        }),
    ),
    MCPToolDefinition(
        name="ageix.repo.write.approve",
        capability_id="repo.write.approve",
        category="repository",
        description="Human-only: issue a single-use approval authorizing one specific mutating git capability call.",
        input_schema=_object_schema({
            "capability_id": _string("The mutating repo capability ID this approval authorizes."),
            "approved_by": _string("Must be the literal string 'human'."),
            "proposal_id": _string("Optional linked proposal ID for traceability."),
            "sprint_id": _string("Optional sprint ID for traceability."),
            "target_ref": _string("Optional branch/tag/ref this approval is scoped to."),
            "reason": _string("Human-readable justification."),
        }, required=["capability_id", "approved_by"]),
    ),
    MCPToolDefinition(
        name="ageix.repo.write.approval.list",
        capability_id="repo.write.approval.list",
        category="repository",
        description="List one-off repo write approvals.",
        input_schema=_object_schema({
            "capability_id": _string("Optional capability ID filter."),
            "status": _string("Optional status filter."),
            "limit": _integer("Maximum approvals to return."),
            "offset": _integer("Zero-based approval offset."),
        }),
    ),
    MCPToolDefinition(
